 ...
 */
class AE_Window_Widget extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'classname' => 'AE_Window_Widget',
            'description' => 'AE Window For Social Sign-on',
        );
        parent::__construct('AE_Window_Widget', 'AE Window', $widget_ops);
    }
    ...
    public function widget($args, $instance) {
        ...
        echo do_shortcode('[ae-window type="' . $type . '" return="' . $return . '" show_after_login="' . $show_after_login . '" ]' . $text . '[/ae-window]');
    }
